  ...
  try {
    ...
    res.end(`
      ...
      <head><style>
        ...
        h2   { color: #00e676; }
        .box { background: #0d0d1e; border: 1px solid rgba(47,128,237,.3); border-radius: 8px; padding: 1rem; margin: 1rem 0; word-break: break-all; font-size: .8rem; }
        .lbl { color: #2f80ed; font-size: .75rem; margin-bottom: .3rem; }
        .ok  { color: #00e676; }
        .warn{ color: #38bdf8; }
      </style></head>
      <body>
