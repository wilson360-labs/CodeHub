...
function buildFullPost(topic, bodyHtml) {
  ...
  const header = `
<div style="background:linear-gradient(135deg,#0d0d1e,#1a0a2e);border:1px solid rgba(47,128,237,.2);border-radius:12px;padding:1.5rem 2rem;margin-bottom:2rem;">
  <div style="font-family:'Courier New',monospace;font-size:.75rem;color:#2f80ed;margin-bottom:.5rem;letter-spacing:.08em;">// codehub-labs.blogspot.com · ${today}</div>
  <h1 style="font-size:1.6rem;font-weight:700;color:#f0f0fa;margin:0 0 .75rem;line-height:1.3;">${topic.title}</h1>
  <div style="display:flex;flex-wrap:wrap;gap:.5rem;">
    ${topic.tags.map(t => `<span style="background:rgba(47,128,237,.12);border:1px solid rgba(47,128,237,.3);color:#ff8c5a;font-size:.72rem;padding:.2rem .65rem;border-radius:999px;">${t}</span>`).join('')}
  </div>
</div>
`;
  ...
  const footer = `
<hr style="border:none;border-top:1px solid rgba(47,128,237,.2);margin:2.5rem 0;">
<div style="background:linear-gradient(135deg,#0d0d1e,#1a0a2e);border:1px solid rgba(47,128,237,.2);border-radius:12px;padding:1.5rem 2rem;text-align:center;">
  ...
  <div style="display:flex;justify-content:center;gap:1rem;flex-wrap:wrap;">
    <a href="${CONFIG.siteUrl}" style="background:linear-gradient(135deg,#2f80ed,#22c55e);color:#fff;text-decoration:none;padding:.5rem 1.2rem;border-radius:8px;font-size:.85rem;font-weight:700;">🚀 Ver CodeHub</a>
    <a href="${CONFIG.siteUrl}/tools" style="background:rgba(47,128,237,.12);border:1px solid rgba(47,128,237,.3);color:#ff8c5a;text-decoration:none;padding:.5rem 1.2rem;border-radius:8px;font-size:.85rem;">🛠 Herramientas</a>
    <a href="${CONFIG.blogUrl}" style="background:rgba(47,128,237,.12);border:1px solid rgba(47,128,237,.3);color:#ff8c5a;text-decoration:none;padding:.5rem 1.2rem;border-radius:8px;font-size:.85rem;">📝 Ver Blog</a>
  </div>
...
<head>
  ...
  <style>
    ...
    h2 { color: #22c55e; margin: 2rem 0 .75rem; }
    a  { color: #2f80ed; }
    code { background: rgba(255,255,255,.08); padding: .1rem .4rem; border-radius: 4px; font-family: 'Courier New', monospace; font-size: .9em; }
    pre  { background: #0d0d1e; border: 1px solid rgba(47,128,237,.2); border-radius: 8px; padding: 1.2rem; overflow-x: auto; }
